...
const data = [
	{
		...
		url: `${nike}`,
		text:
      "The Nike Air Max 270 Older Kids' Shoe is inspired by two icons of Air:the Air Max 180 and Air Max 93. It features Nike's biggest heel Air unit yet for a super-soft ride that feels as impossible as it looks. ",
	},
	{
		id: 2,
    url: `${nike1}`,
    text:"the Air Max 180 and Air Max 93. It features Nike's biggest heel Air unit yet for a super-soft ride that feels as impossible as it looks. "
	},
	{
		id: 3,
    url: `${nike3}`,
		...
		<Container>
			<Container01>
				<Container02>
					...
					{data.map((slide, i) =>
						i === activeIndex ? (
							<Container04 style={{ backgroundImage: `url(${slide.url})` }}></Container04>
						) : (
			...
			<Container05>
				{data.map((slide, index) => (
					<Container06
						className={index === activeIndex ? 'active' : 'non'}
			...
			<Container10>
        {data.map((slide, index) => activeIndex === index ?
        <Text8>
					{slide.text}
				</Text8>
        :<Text8></Text8>
